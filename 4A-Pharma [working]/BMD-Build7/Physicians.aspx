<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Physicians, App_Web_physicians.aspx.cdcab7d2" title=":: 4A-Pharma BMD :: Physicians ::" maintainScrollPositionOnPostBack="true" %>
        ...
        <ContentTemplate>
            <asp:FormView ID="frmViewPhysicians" runat="server" OnDataBound="frmViewPhysicians_DataBound"
                ...
                <PagerSettings FirstPageImageUrl="~/Images/home_n.jpg" FirstPageText="First" LastPageImageUrl="~/Images/End_n.jpg"
                    LastPageText="Last" NextPageImageUrl="~/Images/next_n.jpg" NextPageText="Next"
                    PreviousPageImageUrl="~/Images/previous_n.jpg" PreviousPageText="Previous"></PagerSettings>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td valign="top" align="center" colspan="3" rowspan="1">
                                                    <table style="width: 100%; height: 30px" id="tblsearch" class="tblStyle">
                                                        <tbody>
                                            ...
                                            <tr>
                                                <td valign="top" align="left" rowspan="13">
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td align="left">
                                                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" Display="Dynamic"
                                                                                        ControlToValidate="txtPhysicianName" ErrorMessage="Physician name is required">*</asp:RequiredFieldValidator></td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td align="right">
                                                    ...
                                                    <asp:ObjectDataSource ID="odcPhysicians" runat="server" TypeName="Pharma.BLL.PhysiciansBLL"
                                                        SelectMethod="SelectPhysicians" OldValuesParameterFormatString="original_{0}"></asp:ObjectDataSource>
                                                    <asp:ObjectDataSource ID="odsPhysicianTitles" runat="server" TypeName="Pharma.BLL.LookupsBLL"
                                                    ...
                                                    <asp:ObjectDataSource ID="odsPhysicianSpecialitities" runat="server" TypeName="Pharma.BLL.LookupsBLL"
                                                        SelectMethod="GetSCodeByGCode" OldValuesParameterFormatString="original_{0}">
                                                        <SelectParameters>
                                                    ...
                                                    <asp:ObjectDataSource ID="odsMedicalAccounts" runat="server" TypeName="Pharma.BLL.MedicalAccountsBLL"
                                                        SelectMethod="SelectMedicalAccounts" OldValuesParameterFormatString="original_{0}">
                                                    </asp:ObjectDataSource>
                                                </td>
                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                                <td colspan="3" rowspan="1">
                                                                                    <table style="width: 390px" id="tblScore" runat="server">
                                                                                        <tbody>
                                                                                            <tr>
                                                                                                        ...
                                                                                                        <asp:GridView ID="gvScores" runat="server" Width="95%" BorderWidth="1px" BorderStyle="Solid"
                                                                                                            ...
                                                                                                            <Columns>
                                                                                                                <asp:TemplateField HeaderText="Date">
                                                                                                                    ...
                                                                                                                    <FooterTemplate>
                                                                                                                        <asp:TextBox ID="txtScoreDate" runat="server" Enabled="False" Width="75px" CssClass="inputs"
                                                                                                                            Visible="true"></asp:TextBox><%--'<%# CurrentUserInfo.IsAdminRank %>'--%>
                                                                                                                    </FooterTemplate>
                                                                                                                    <ItemTemplate>
                                                                                                                        <asp:Label ID="lblScoreDate" runat="server" Width="35px" Text='<%# Bind("strScoreDate") %>'></asp:Label>
                                                                                                                    </ItemTemplate>
                                                                                                                ...
                                                                                                                <asp:TemplateField HeaderText="P">
                                                                                                                    <EditItemTemplate>
                                                                                                                        <asp:TextBox ID="txtPotential" runat="server" Text='<%# Bind("Potential") %>' Width="35px"
                                                                                                                            CssClass="inputs"></asp:TextBox><asp:RequiredFieldValidator ID="rfvPotential" runat="server"
                                                                                                                                ControlToValidate="txtPotential" Display="Dynamic" ErrorMessage="*" ValidationGroup="vgEditScores"></asp:RequiredFieldValidator><asp:RangeValidator
                                                                                                                                    ...
                                                                                                                                    ErrorMessage="*" MaximumValue="30.00" MinimumValue="00.00" ValidationGroup="vgEditScores"
                                                                                                                                    Type="Double"></asp:RangeValidator>
                                                                                                                    </EditItemTemplate>
                                                                                                                    <FooterTemplate>
                                                                                                                        <asp:TextBox ID="txtNewPotential" runat="server" Width="35px" CssClass="inputs" Visible="true"></asp:TextBox><%--'<%# CurrentUserInfo.IsAdminRank %>'--%>
                                                                                                                        <asp:RequiredFieldValidator ID="rfvNewPotential" runat="server" ControlToValidate="txtNewPotential"
                                                                                                                            Display="Dynamic" ErrorMessage="*" ValidationGroup="vgNewScores"></asp:RequiredFieldValidator><asp:RangeValidator
                                                                                                                                ...
                                                                                                                                ErrorMessage="*" MaximumValue="30.00" MinimumValue="00.00" ValidationGroup="vgNewScores"
                                                                                                                                Type="Double"></asp:RangeValidator>
                                                                                                                    </FooterTemplate>
                                                                                                                    <ItemTemplate>
                                                                                                                ...
                                                                                                                <asp:TemplateField HeaderText="G">
                                                                                                                    <EditItemTemplate>
                                                                                                                        <asp:TextBox ID="txtGrade" runat="server" Text='<%# Bind("Grade") %>' Width="35px"
                                                                                                                            CssClass="inputs"></asp:TextBox><asp:RequiredFieldValidator ID="rfvGrade" runat="server"
                                                                                                                                ControlToValidate="txtGrade" Display="Dynamic" ErrorMessage="*" ValidationGroup="vgEditScores"></asp:RequiredFieldValidator><asp:RangeValidator
                                                                                                                                    ...
                                                                                                                                    MaximumValue="40.00" MinimumValue="00.00" ValidationGroup="vgEditScores" Type="Double"></asp:RangeValidator>
                                                                                                                    </EditItemTemplate>
                                                                                                                    <FooterTemplate>
                                                                                                                        <asp:TextBox ID="txtNewGrade" runat="server" Width="35px" CssClass="inputs" Visible="true"></asp:TextBox><%--'<%# CurrentUserInfo.IsAdminRank %>'--%>
                                                                                                                        <asp:RequiredFieldValidator ID="rfvNewGrade" runat="server" ControlToValidate="txtNewGrade"
                                                                                                                            Display="Dynamic" ErrorMessage="*" ValidationGroup="vgNewScores"></asp:RequiredFieldValidator><asp:RangeValidator
                                                                                                                                ...
                                                                                                                                ErrorMessage="*" MaximumValue="40.00" MinimumValue="00.00" ValidationGroup="vgNewScores"
                                                                                                                                Type="Double"></asp:RangeValidator>
                                                                                                                    </FooterTemplate>
                                                                                                                    <ItemTemplate>
                                                                                                                ...
                                                                                                                <asp:TemplateField HeaderText="I">
                                                                                                                    <EditItemTemplate>
                                                                                                                        <asp:TextBox ID="txtInference" runat="server" Text='<%# Bind("Inference") %>' Width="35px"
                                                                                                                            CssClass="inputs"></asp:TextBox><asp:RequiredFieldValidator ID="rfvInference" runat="server"
                                                                                                                                ControlToValidate="txtInference" Display="Dynamic" ErrorMessage="*" ValidationGroup="vgEditScores"></asp:RequiredFieldValidator><asp:RangeValidator
                                                                                                                                    ...
                                                                                                                                    ErrorMessage="*" MaximumValue="10.00" MinimumValue="00.00" ValidationGroup="vgEditScores"
                                                                                                                                    Type="Double"></asp:RangeValidator>
                                                                                                                    </EditItemTemplate>
                                                                                                                    <FooterTemplate>
                                                                                                                        <asp:TextBox ID="txtNewInference" runat="server" Width="35px" CssClass="inputs" Visible="true"><%--'<%# CurrentUserInfo.IsAdminRank %>'--%>
                                                                                                                            ...
                                                                                                                            Display="Dynamic" ErrorMessage="*" ValidationGroup="vgNewScores"></asp:RequiredFieldValidator><asp:RangeValidator
                                                                                                                                ...
                                                                                                                                ErrorMessage="*" MaximumValue="10.00" MinimumValue="00.00" ValidationGroup="vgNewScores"
                                                                                                                                Type="Double"></asp:RangeValidator>
                                                                                                                    </FooterTemplate>
                                                                                                                    <ItemTemplate>
                                                                                                                ...
                                                                                                                <asp:TemplateField HeaderText="Add">
                                                                                                                    <EditItemTemplate>
                                                                                                                        <asp:TextBox ID="txtAdditional" runat="server" Text='<%# Bind("Additional") %>' Width="35px"
                                                                                                                            CssClass="inputs"></asp:TextBox><asp:RequiredFieldValidator ID="rfvAdditional" runat="server"
                                                                                                                                ControlToValidate="txtAdditional" Display="Dynamic" ErrorMessage="*" ValidationGroup="vgEditScores"></asp:RequiredFieldValidator><asp:RangeValidator
                                                                                                                                    ...
                                                                                                                                    ErrorMessage="*" MaximumValue="20.00" MinimumValue="00.00" ValidationGroup="vgEditScores"
                                                                                                                                    Type="Double"></asp:RangeValidator>
                                                                                                                    </EditItemTemplate>
                                                                                                                    <FooterTemplate>
                                                                                                                        <asp:TextBox ID="txtNewAdditional" runat="server" Width="35px" CssClass="inputs"
                                                                                                                            Visible="true"><%--'<%# CurrentUserInfo.IsAdminRank %>'--%>
                                                                                                                        </asp:TextBox><asp:RequiredFieldValidator ID="rfvNewAdditional" runat="server" ControlToValidate="txtNewAdditional"
                                                                                                                            Display="Dynamic" ErrorMessage="*" ValidationGroup="vgNewScores"></asp:RequiredFieldValidator><asp:RangeValidator
                                                                                                                                ID="rvNewAdditional" runat="server" ControlToValidate="txtNewAdditional" Display="Dynamic"
                                                                                                                                ErrorMessage="*" MaximumValue="20.00" MinimumValue="00.00" ValidationGroup="vgNewScores"
                                                                                                                                Type="Double"></asp:RangeValidator>
                                                                                                                    </FooterTemplate>
                                                                                                                    <ItemTemplate>
                                                                                                                ...
                                                                                                                <asp:TemplateField ShowHeader="False">
                                                                                                                    <ItemTemplate>
                                                                                                                        <asp:LinkButton ID="LinkButton1" runat="server" CausesValidation="False" CommandName="Delete"
                                                                                                                            Text="Delete" OnClientClick="return confirm('Are you sure you want to delete this Score?');"
                                                                                                                            Visible="true"></asp:LinkButton><%--'<%# CurrentUserInfo.IsAdminRank %>'--%>
                                                                                                                    </ItemTemplate>
                                                                                                                </asp:TemplateField>
                                                                                                            </Columns>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td align="left">
                                                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtPhysicianName"
                                                                                        Display="Dynamic" ErrorMessage="Physician name is required">*</asp:RequiredFieldValidator></td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td align="right">
                                                                                    <asp:Label ID="lblPharmacistName" runat="server" CssClass="MainfontStyle" Text="AKA :"></asp:Label></td>
