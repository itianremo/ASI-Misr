<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="PrivateClinics, App_Web_privateclinics.aspx.cdcab7d2" title=":: 4A-Pharma BMD :: Private Clinics ::" maintainScrollPositionOnPostBack="true" %>
        ...
        <tr>
            <td align="center" colspan="3" rowspan="3">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td style="text-align: left">
                                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Clinic name is required"
                                                                                Display="Dynamic" ControlToValidate="txtClinicName">*</asp:RequiredFieldValidator></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td align="right">
                ...
                <asp:ObjectDataSource ID="odsPhysicians" runat="server" OldValuesParameterFormatString="original_{0}"
                    SelectMethod="GetPhysicianNameList" TypeName="Pharma.BLL.PhysiciansBLL"></asp:ObjectDataSource>
            </td>
        </tr>
        <tr>
        </tr>
