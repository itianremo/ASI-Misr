...
<%@ Page Language="c#" Inherits="frmNotes_test" ValidateRequest="false"
    CodeFile="EmailForm.aspx.cs" Async="true" Theme="Red" %>
...
<head>
    ...
    <script type="text/javascript" src="Scripts/Scripts.js"></script>
     ...
     <script type="text/javascript" src="Scripts/spell.js" ></script>
    ...
    <script type="text/javascript">
		...
		function closeNotes() {
		  ...
		  // addr.split("?")[1].split('&')[1].split("=")[1];
		   var textToFind = 'sent';
		   var dd;
		   if (addr.split("?")[1].split('&')[1].split("=")[1]=='credit')
		       dd = window.opener.parent.frmAccountLists['TabContainer1_TabPanel7_DueDiligance1_ddlCreditCheckStatus'];
		   else dd = window.opener.parent.frmAccountLists['TabContainer1_TabPanel7_DueDiligance1_ddlMasterStatus'];
...
<body onload="toggleLayer('divPanel','none');">
                                ...
                                <tbody style="text-align: center" valign="top">
                                    <tr>
                                        ...
                                        <td style="width: 80%; height: 27px; text-align: left">
                                            <div id="divPanel"  style="width: auto; position: absolute; left: 22px; top: 399px;" align="center" class="FunctionBlock" Visible="False">
                                    ...
                                    <tr>
                                        <td style="width: 10%; height: 83px" rowspan="4" valign="bottom">
                                            ...
                                            <asp:ImageButton ID="imgSendMail" runat="server" ImageUrl="~/Images/Send-n.jpg" 
                                                OnClick="btnSendMail_Click"></asp:ImageButton>
                                        </td>
                                        <td style="width: 9.11%; height: 27px; text-align: right">
                                    ...
                                    <tr>
                                        <td style="width: 9.11%; text-align: right">
                                            <input id="btnTo" style="width: 53px; height: 24px" onclick="openEmail('btnTo');"
                                                type="button" value="To..." onclick="return btnTo_onclick()" 
                                    ...
                                    <tr>
                                        <td style="width: 9.11%; height: 26px; text-align: right">
                                            <input id="btnCC" style="width: 53px; height: 24px" onclick="openEmail('btnCC');"
                                                type="button" value="CC..." name="Button1" disabled="disabled"></td>
                                    ...
                                    <tr>
                                        <td style="width: 10%">
                                            ...
                                            <img onmousedown="src='images/Cancel_s.jpg'" id="imgCancelNote" onmouseover="src='images/Cancel2.jpg'"
                                                onclick="closeNotes();" onmouseout="src='images/Cancel3.jpg'"
                                                alt="Cancel" src="Images/Cancel1.jpg">
                                        </td>
                                        <td style="width: 9.11%; text-align: right">
                                            <input id="btnBCC" style="width: 53px; height: 24px" onclick="openEmail('btnBCC');"
                                                type="button" value="BCC..." name="Button2" disabled="disabled"></td>
                                        <td style="width: 80%; text-align: left">
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 9.11%; height: 25px; text-align: right">
                                            &nbsp;</td>
                                        <td valign=middle style="width: 80%; height: 25px; text-align: left">
                                            <asp:HyperLink ID="lnkASIAttachment" Text="ASI Attachment" runat="server" NavigateUrl="#" Target="_blank" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width: 10%; height: 25px">
