...
public static class Serializer
{
    ...
    /// <summary>
    /// Serializes any instances of any objects to a string.
    /// </summary>
    /// <param name="instance">The instance of an object to serialize.</param>
    ...
    /// </summary>
    /// <param name="instance">Specify an instance of an object to deserialize.</param>
    /// <param name="strBuffer">A string containing the serialized object, that needs
    /// to be deserialized</param>
    /// <returns>A deserialized object.</returns>
    public static T Deserialize<T>(T instance, string strBuffer)
    {
        if (string.IsNullOrEmpty(strBuffer))
            throw new ArgumentNullException("The string is null.");

        byte[] buffer = Convert.FromBase64String(strBuffer);
