                            ...
                            <td align="center" valign="top">
                                <table width="100%" id="tblPlanFields" background="../Images/BG-1.jpg" class="tblStyle">
                                    ...
                                    <tr>
                                                            ...
                                                            <td colspan="3" rowspan="3" align="right" valign="top">
                                                                <table id="tblInnerContL" width="100%">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td align="left">
                                                                            <asp:DropDownList ID="ddlDayType" runat="server" CssClass="inputs" Width="200px" OnSelectedIndexChanged="ddlDayType_SelectedIndexChanged"
                                                                                AutoPostBack="True">
                                                                            </asp:DropDownList></td>
                                                                        <td>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td align="left">
                                                                            <asp:DropDownList ID="ddlHour" runat="server" Width="100px" Enabled="False" CssClass="inputs">
                                                                            ...
                                                                            </asp:DropDownList><asp:DropDownList ID="ddlMinute" runat="server" Width="100px"
                                        ...
                                        <td align="left" valign="top" colspan="2" rowspan="6">
                                                                                    ...
                                                                                    <table id="Table4" width="100%">
                                                                                        <tr>
                                                                                            <td colspan="3">
                                                                                                ...
                                                                                                <asp:TextBox ID="txtdayST" runat="server" CssClass="inputs" Width="100px"></asp:TextBox><asp:RegularExpressionValidator
                                                                                                    ID="revTimeFormat" runat="server" ControlToValidate="txtdayST" ErrorMessage='Enter valid time format ex."12:00 ã" or "12:00 PM"'
                                                                                                    ValidationExpression="^((([0]?[1-9]|1[0-2])(:|\.)[0-5][0-9]((:|\.)[0-5][0-9])?( )?(AM|am|aM|Am|PM|pm|pM|Pm|Õ|ã))|(([0]?[0-9]|1[0-9]|2[0-3])(:|\.)[0-5][0-9]((:|\.)[0-5][0-9])?))$">*</asp:RegularExpressionValidator><asp:Button
                                                                                                        ID="btnUpdateSP" runat="server" OnClick="btnUpdateSP_Click" Text="Update" ToolTip="Update Starting Point and Time"
                                                                                                        Visible="False" CssClass="inputs" /></td>
                                                                                        </tr>
                                                                                        <tr>
                                                ...
                                                <td align="center" colspan="11" rowspan="1">
                                                    <table width="100%" id="tblBricksStatistics" class="tblStyle">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left" rowspan="5" width="1%">
                                                            </td>
                                                            <td colspan="2" align="center" rowspan="4" valign="top">
