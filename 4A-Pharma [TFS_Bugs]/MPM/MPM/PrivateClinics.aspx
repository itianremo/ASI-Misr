<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="PrivateClinics.aspx.cs" Inherits="PrivateClinics" Title=":: MPM - BMD :: Private Clinics ::" %>
                            ...
                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                <ContentTemplate>
                                    ...
                                    <asp:Label ID="lblmsg" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="12px"
                                        ...
                                        Visible="False"></asp:Label><asp:Label ID="lblDupName" runat="server" Font-Names="Arial" Font-Size="12px" ForeColor="Red"
