<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    EnableEventValidation="false" CodeFile="Distributors.aspx.cs" Inherits="Distributors"
    Title=":: MPM - BMD :: Distributors ::" %>
                            ...
                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                <ContentTemplate>
                                    <asp:FormView ID="frmViewDistributors" runat="server" AllowPaging="True" DataKeyNames="DistributorID"
                                        ...
                                        BorderColor="DarkGray" BorderStyle="Solid" BorderWidth="1px" Width="800px" Height="520px"
                                        OnDataBound="frmViewDistributors_DataBound">
                                                        ...
                                                        <td colspan="3" rowspan="3">
                                                            <table width="100%">
                                                                <tbody>
                                                                    <tr>
                                                                        <td colspan="4">
                                                                            <table id="tblsearch" class="tblStyle" style="z-index: 1; position: relative; width: 100%;
                                                                                height: 30px">
                                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        <td align="left" colspan="2" width="60%">
                                                                            ...
                                                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtDistributorName"
                                                                                Display="Dynamic" ErrorMessage="Invalid Spelling" ValidationExpression="^([a-zA-Z]{1})([_\\'\,\.\-\ a-zA-Z0-9])*">*</asp:RegularExpressionValidator>
                                                                            <asp:Label ID="lblDistDupName" runat="server" Font-Names="Arial" Font-Size="12px"
                                                                                ForeColor="Red" Text="Duplicated name" Visible="False"></asp:Label></td>
                                                                        <td style="width: 2%">
                                                                        </td>
                                                                        <td style="width: 38%">
                                                                        </td>
                                                                                    ...
                                                                                    <table id="tblAddBranch" class="tblStyle" width="100%">
                                                                                        ...
                                                                                        <tr>
                                                                                            <td align="left" valign="top">
                                                                                                <asp:TextBox ID="txtNewBranchName" runat="server" CssClass="inputs" Width="150px"></asp:TextBox><br />
                                                                                                <asp:Label ID="lblVBranchName" runat="server" Font-Names="Arial" Font-Size="12px"
                                                                                                    ForeColor="Red" Text="Name is required" Visible="False" Font-Bold="False"></asp:Label><asp:RegularExpressionValidator
                                                                                                        ...
                                                                                                        Display="Dynamic" ErrorMessage="Invalid Branch name" ValidationExpression="^([a-zA-Z]{1})([\'\,\.\-\ a-zA-Z0-9])*">*</asp:RegularExpressionValidator>
                                                                                            ...
                                                                                            <td align="left" colspan="2" valign="top">
                                                                                                ...
                                                                                                <asp:Label ID="lblVBranchAddress" runat="server" Font-Names="Arial" Font-Size="12px"
                                                                                                    ForeColor="Red" Text="Address is required" Visible="False"></asp:Label><asp:RegularExpressionValidator
                                                                                                        ...
                                                                                                        Display="Dynamic" ErrorMessage="Invalid Branch address" ValidationExpression="^([a-zA-Z]{1})([\'\,\.\-\ a-zA-Z0-9])*">*</asp:RegularExpressionValidator></td>
                                                                                            <td align="left" colspan="1" valign="top">
                                                                                                <asp:Button ID="btnNewBranch" runat="server" CssClass="button" Text="Add Branch"
                                                                                                    OnClick="btnNewBranch_Click" /></td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                                            ...
                                                                                                            <tr>
                                                                                                                <td align="center" colspan="10" rowspan="1">
                                                                                                                    <asp:Panel ID="pnlBranches" runat="server" Height="250px" HorizontalAlign="Left"
                                                                                                                        ...
                                                                                                                        <asp:GridView ID="gvBranches" runat="server" AutoGenerateColumns="False" BackColor="White"
                                                                                                                            BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" DataKeyNames="BranchID"
                                                                                                                            Width="95%" CellPadding="3" OnRowCreated="gvBranches_RowCreated" OnSelectedIndexChanging="gvBranches_SelectedIndexChanging"
                                                                                                                            OnDataBound="gvBranches_DataBound" OnRowDeleting="gvBranches_RowDeleting">
                                                                                                                            <FooterStyle BackColor="White" ForeColor="#000066" />
                                                                                                                            <Columns>
                                                                                                                                        ...
                                                                                                                                        <asp:TextBox ID="txtBranchAddress" runat="server" CssClass="inputs" Text='<%# Bind("BranchAddress") %>'
                                                                                                                                            Visible="False" Width="90%"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator2"
                                                                                                                                                runat="server" ControlToValidate="txtBranchAddress" Display="Dynamic" ErrorMessage="Branch address is required">*</asp:RequiredFieldValidator><asp:RegularExpressionValidator
                                                                                                                                                    ...
                                                                                                                                                    Display="Dynamic" ErrorMessage="Invalid Branch address" ValidationExpression="^([a-zA-Z]{1})([\'\,\.\-\ a-zA-Z0-9])*">*</asp:RegularExpressionValidator>
                                                                                                                                    </ItemTemplate>
                                                                                                                                </asp:TemplateField>
                                                                    ...
                                                                    <tr>
                                                                        <td align="left" colspan="2" style="width: 60%; height: 30px;">
                                                                            ...
                                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtDistributorName"
                                                                                Display="Dynamic" ErrorMessage="Distributor name is required">*</asp:RequiredFieldValidator>
                                                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtDistributorName"
                                                                                Display="Dynamic" ErrorMessage="Invalid Spelling" ValidationExpression="^([a-zA-Z]{1})([\'\,\.\-\ a-zA-Z0-9])*">*</asp:RegularExpressionValidator></td>
                                                                        <td style="width: 2%">
                                                                        </td>
                                                                        <td style="width: 38%">
                                                                        </td>
