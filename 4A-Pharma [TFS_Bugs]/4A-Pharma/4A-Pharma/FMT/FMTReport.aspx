<%@ Page Language="C#" MasterPageFile="~/FMT/FMTMasterPage.master" AutoEventWireup="true"
    CodeFile="FMTReport.aspx.cs" Inherits="FMT_FMTReport" EnableEventValidation="false"
    Culture="ar-EG" UICulture="ar-EG" Title=":: 4A-Pharma FMT :: M.R. Plan Feedback::" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table width="100%">
        <tbody>
            ...
            <tr>
                <td id="TDWeekContent" align="center" colspan="3">
                    <table cellpadding="0" cellspacing="0" class="tblStyle" style="width: 100%">
                        <tbody>
                            <tr>
                                <td colspan="3">
                                    <table align="left" id="tblWeeKContent" background="../Images/BG-1.jpg" class="tblStyle"
                                        width="100%">
                                        <tbody>
                                            <tr>
                                                <td align="left" background="../Images/TableHead-BG.jpg" colspan="11" rowspan="1"
                                                    ...
                                                    <asp:Label ID="lblPlanFeedback" runat="server" CssClass="MainfontStyle" Font-Size="18px"
                                                        Text="Plan Feedback"></asp:Label>
                                                </td>
                                                <td align="center" background="../Images/TableHead-BG.jpg" colspan="1" rowspan="1"
                                                    style="height: 20px">
                                                    <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                                        <ContentTemplate>
                                                            <asp:HyperLink ID="lnkPrint" runat="server" CssClass="MainfontStyle" Target="_blank"
                                                                ToolTip="Print FMT Report">Print Report</asp:HyperLink>
                                                        </ContentTemplate>
                                                    </asp:UpdatePanel>
                                                </td>
                                            </tr>
                                                                        ...
                                                                        <table id="Table4" width="100%">
                                                                            <tr>
                                                                                <td colspan="3" align="center" valign="middle">
                                                                                    ...
                                                                                    <asp:TextBox ID="txtPlanDate" runat="server" CssClass="inputs" Width="175px" AutoPostBack="True"
                                                                                        OnTextChanged="txtPlanDate_TextChanged"></asp:TextBox>
                                                                                    <asp:ImageButton ID="imgPlanDate" runat="server" AlternateText="Pick a date" CssClass="HandOverCursor"
                                                                                        ImageUrl="~/Images/Calender.gif" Width="25px" CausesValidation="False" />
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                    ...
                                                                                    <table id="tblSatVisits" runat="server" class="tblStyle" width="100%">
                                                                                        <tr>
                                                                                            <td background="../Images/TableHead-BG.jpg" colspan="3" align="left">
                                                                                                <asp:LinkButton ID="lnkbtnSatVisits" runat="server" CausesValidation="False" CssClass="FMTLinkFontStyle"
                                                                                                    OnClick="lnkbtnSatVisits_Click">LinkButton</asp:LinkButton>
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td colspan="3">
                                                                                                <asp:GridView ID="gvSatVisits" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                                                                                    ...
                                                                                                    <Columns>
                                                                                                        ...
                                                                                                        <asp:TemplateField HeaderText="Visited">
                                                                                                            ...
                                                                                                            <HeaderStyle Width="10%" />
                                                                                                            <ItemTemplate>
                                                                                                                <asp:RadioButtonList ID="rblIsVisited" runat="server" RepeatDirection="Horizontal"
                                                                                                                    SelectedValue='<%# Bind("IsVisited") %>'>
                                                                            ...
                                                                            <tr>
                                                                                <td colspan="3">
                                                                                    <table id="tblSunVisits" runat="server" class="tblStyle" width="100%">
                                                                                        <tr>
                                                                                            <td background="../Images/TableHead-BG.jpg" colspan="3" align="left">
                                                                                                <asp:LinkButton ID="lnkbtnSunVisits" runat="server" CausesValidation="False" CssClass="FMTLinkFontStyle"
                                                                                                    OnClick="lnkbtnSunVisits_Click">LinkButton</asp:LinkButton>
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td colspan="3">
                                                                            ...
                                                                            <tr>
                                                                                <td colspan="3">
                                                                                    <table id="tblMonVisits" runat="server" class="tblStyle" width="100%">
                                                                                        <tr>
                                                                                            <td background="../Images/TableHead-BG.jpg" colspan="3" align="left">
                                                                                                <asp:LinkButton ID="lnkbtnMonVisits" runat="server" CausesValidation="False" CssClass="FMTLinkFontStyle"
                                                                                                    OnClick="lnkbtnMonVisits_Click">LinkButton</asp:LinkButton>
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td colspan="3">
                                                                                                <asp:GridView ID="gvMonVisits" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                                                                                    BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px"
                                                                                                    CellPadding="3" DataKeyNames="VisitID,ModuleRefID,PM,IsPlanned" EmptyDataText="No Data Found"
                                                                            ...
                                                                            <tr>
                                                                                <td colspan="3">
                                                                                    <table id="tblTueVisits" runat="server" class="tblStyle" width="100%">
                                                                                        <tr>
                                                                                            <td background="../Images/TableHead-BG.jpg" colspan="3" align="left">
                                                                                                <asp:LinkButton ID="lnkbtnTueVisits" runat="server" CausesValidation="False" CssClass="FMTLinkFontStyle"
                                                                                                    OnClick="lnkbtnTueVisits_Click">LinkButton</asp:LinkButton>
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td colspan="3">
                                                                                                <asp:GridView ID="gvTueVisits" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                                                                                    BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px"
                                                                                                    CellPadding="3" DataKeyNames="VisitID,ModuleRefID,PM,IsPlanned" EmptyDataText="No Data Found"
                                                                            ...
                                                                            <tr>
                                                                                <td colspan="3">
                                                                                    <table id="tblWedVisits" runat="server" class="tblStyle" width="100%">
                                                                                        <tr>
                                                                                            <td background="../Images/TableHead-BG.jpg" colspan="3" align="left">
                                                                                                <asp:LinkButton ID="lnkbtnWedVisits" runat="server" CausesValidation="False" CssClass="FMTLinkFontStyle"
                                                                                                    OnClick="lnkbtnWedVisits_Click">LinkButton</asp:LinkButton>
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td colspan="3">
                                                                                                <asp:GridView ID="gvWedVisits" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                                                                                    BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px"
                                                                                                    CellPadding="3" DataKeyNames="VisitID,ModuleRefID,PM,IsPlanned" EmptyDataText="No Data Found"
                                                                            ...
                                                                            <tr>
                                                                                <td colspan="3">
                                                                                    <table id="tblThurVisits" runat="server" class="tblStyle" width="100%">
                                                                                        <tr>
                                                                                            <td background="../Images/TableHead-BG.jpg" colspan="3" align="left">
                                                                                                <asp:LinkButton ID="lnkbtnThurVisits" runat="server" CausesValidation="False" CssClass="FMTLinkFontStyle"
                                                                                                    OnClick="lnkbtnThurVisits_Click">LinkButton</asp:LinkButton>
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td colspan="3">
                                                                                                <asp:GridView ID="gvThurVisits" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                                                                                    BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px"
                                                                                                    CellPadding="3" DataKeyNames="VisitID,ModuleRefID,PM,IsPlanned" EmptyDataText="No Data Found"
                                                                            ...
                                                                            <tr>
                                                                                <td colspan="3">
                                                                                    <table id="tblFriVisits" runat="server" class="tblStyle" width="100%">
                                                                                        <tr>
                                                                                            <td background="../Images/TableHead-BG.jpg" colspan="3" align="left">
                                                                                                <asp:LinkButton ID="lnkbtnFriVisits" runat="server" CausesValidation="False" CssClass="FMTLinkFontStyle"
                                                                                                    OnClick="lnkbtnFriVisits_Click">LinkButton</asp:LinkButton>
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td colspan="3">
                                                                                                <asp:GridView ID="gvFriVisits" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                                                                                    BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px"
                                                                                                    CellPadding="3" DataKeyNames="VisitID,ModuleRefID,PM,IsPlanned" EmptyDataText="No Data Found"
                                                                            ...
                                                                            <tr>
                                                                                <td colspan="3" align="center" valign="middle">
                                                                                    &nbsp;<asp:ImageButton ID="btnSaveFeedBack" runat="server" AlternateText="Save FeedBack"
                                                                                        CausesValidation="False" ImageUrl="~/Images/save_n.jpg" OnClick="btnSaveFeedBack_Click"
                                                                                        Visible="False" />
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td align="center" colspan="3" valign="middle">
                                                                                    <asp:Label ID="lblfeedbackmsg" runat="server" Font-Bold="True" Font-Names="Arial"
                                                                                        Font-Size="13px" ForeColor="Green" Text="Visit Feedback Saved..." Visible="False"></asp:Label>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td align="center" colspan="3" valign="middle">
                                                                                    <asp:Label ID="lblNoPlans" runat="server" CssClass="StyleNoData" Font-Bold="True"
                                                                                        Font-Size="16px" Text="No approved plans found for this date..." Visible="False"></asp:Label>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
                                            ...
                                            <tr>
                                                <td align="center" colspan="12" rowspan="1">
                                                    <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <table id="tblPlanFields" runat="server" background="../Images/BG-1.jpg" class="tblStyle"
                                                                width="100%">
                                                                <tr>
                                                                                            ...
                                                                                            <table id="tblInnerContL" width="100%">
                                                                                                <tr>
                                                                                                    <td align="left" background="../Images/TableHead-BG.jpg" colspan="3" height="20">
                                                                                                        <asp:Label ID="Label4" runat="server" CssClass="MainfontStyle" Text="Plan Items"></asp:Label>
                                                                                                    </td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td align="right">
                                                                                                        <asp:Label ID="lblAddVDate" runat="server" CssClass="MainfontStyle" Text="Insert Plan In:"></asp:Label>
                                                                                                    </td>
                                                                                                    <td align="left">
                                                                                                        <asp:DropDownList ID="ddlPlanDate" runat="server" CssClass="inputs" Enabled="False"
                                                                                                            OnSelectedIndexChanged="ddlAddItem_SelectedIndexChanged" Width="200px">
                                                                                                        </asp:DropDownList>
                                                                                                    </td>
                                                                                                    <td align="left">
                                                                                                    </td>
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td align="right">
                                                                                                        <asp:Label ID="lblSP" runat="server" CssClass="MainfontStyle" Text="Starting Point:"></asp:Label>
                                                                                                    </td>
                                                                                                    <td align="left">
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td align="right">
                                                                                                        <asp:Label ID="lblST" runat="server" CssClass="MainfontStyle" Text="Starting Time:"></asp:Label>
                                                                                                    </td>
                                                                                                    <td align="left">
                                                                                                        ...
                                                                                                        <asp:DropDownList ID="ddlMinute" runat="server" CssClass="inputs" Enabled="False"
                                                                                                            Width="100px">
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td align="right">
                                                                                                        <asp:Label ID="lblAdd" runat="server" CssClass="MainfontStyle" Text="Add:"></asp:Label>
                                                                                                    </td>
                                                                                                    <td align="left">
                                                                                                ...
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td align="left">
                                                                                                        <asp:RequiredFieldValidator ID="rfvddlAddRel" runat="server" ControlToValidate="ddlAddRel"
                                                                                                            Display="Dynamic" Enabled="False" ErrorMessage="Module name is required">*</asp:RequiredFieldValidator>
                                                                                                    </td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td align="right">
                                                                                                    ...
                                                                                                    <td align="left">
                                                                                                        <%--OnDataBound="lbProducts_DataBound"--%>
                                                                                                        <asp:ListBox ID="lbSubModule" runat="server" CssClass="inputs" SelectionMode="Multiple"
                                                                                                            Visible="False" Width="200px"></asp:ListBox>
                                                                                                    </td>
                                                                                                    <td align="left">
                                                                                                        <asp:RequiredFieldValidator ID="rfvlbSubModule" runat="server" ControlToValidate="lbSubModule"
                                                                                                            Display="Dynamic" Enabled="False" ErrorMessage="Subname is required">*</asp:RequiredFieldValidator>
                                                                                                    </td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td align="right">
                                                                                                    ...
                                                                                                    <td align="left">
                                                                                                        <asp:RequiredFieldValidator ID="rfvtxtOthers" runat="server" ControlToValidate="txtOthers"
                                                                                                            Display="Dynamic" Enabled="False" ErrorMessage="Mention other is required">*</asp:RequiredFieldValidator>
                                                                                                    </td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td align="right">
                                                                                                        <asp:Label ID="Label7" runat="server" CssClass="MainfontStyle" Text="Shift Visit:"></asp:Label>
                                                                                                    </td>
                                                                                                    <td align="left">
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td align="right">
                                                                                                        <asp:Label ID="lblDoubleVisit" runat="server" CssClass="MainfontStyle" Text="Double Visit:"></asp:Label>
                                                                                                    </td>
                                                                                                    <td align="left">
                                                                                            ...
                                                                                            <table id="tblInnrR" width="100%">
                                                                                                <tr>
                                                                                                    <td align="left" background="../Images/TableHead-BG.jpg" colspan="2" height="20"
                                                                                                        valign="top">
                                                                                                        <asp:Label ID="Label5" runat="server" CssClass="MainfontStyle" Text="Plan Scope"></asp:Label>
                                                                                                    </td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td height="10">
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td align="right">
                                                                                                        <asp:Label ID="lblvisit" runat="server" CssClass="MainfontStyle" Text="Visit Type:"></asp:Label>
                                                                                                    </td>
                                                                                                    <td>
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td align="right" valign="middle">
                                                                                                        <asp:Label ID="lblProducts" runat="server" CssClass="MainfontStyle" Text="Products:"></asp:Label>
                                                                                                    </td>
                                                                                                    <td valign="middle">
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td align="right">
                                                                                                        <asp:Label ID="lblMarktMat" runat="server" CssClass="MainfontStyle" Text="Marketing Materials:"></asp:Label>
                                                                                                    </td>
