<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="Physicians.aspx.cs" Inherits="Physicians" Title=":: 4A-Pharma BMD :: Physicians ::" %>
                                        ...
                                        <tbody>
                                                        ...
                                                        <tbody>
                                                            <tr align="center" width="50%">
                                                                <td style="width: 40%" align="right">
                                                                    <asp:Label ID="lblSearch" runat="server" CssClass="MainfontStyle" Text="Search Physicians:"></asp:Label>
                                                                </td>
                                                                <td align="left">
                                            ...
                                            <tr>
                                                                ...
                                                                <td>
                                                                    <table width="100%">
                                                                        <tbody>
                                                                            <tr>
                                                                                <td align="right">
                                                                                    <asp:Label ID="lblName" runat="server" CssClass="MainfontStyle" Text="Physician Name :"></asp:Label>
                                                                                </td>
                                                                                <td align="left">
                                                                                    <asp:TextBox ID="txtPhysicianName" runat="server" CssClass="inputs" Width="270px"
                                                                                        Text='<%# Bind("PhysicianName") %>' ReadOnly="True"></asp:TextBox>
                                                                                </td>
                                                                                <td align="left">
                                                                            ...
                                                                            <tr>
                                                                                <td align="right">
                                                                                    <asp:Label ID="lblPharmacistName" runat="server" CssClass="MainfontStyle" Text="AKA :"></asp:Label>
                                                                                </td>
                                                                                <td align="left">
                                                                            ...
                                                                            <tr>
                                                                                <td align="right">
                                                                                    <asp:Label ID="lblGov" runat="server" CssClass="MainfontStyle" Text="Title :"></asp:Label>
                                                                                </td>
                                                                                <td align="left">
                                                                                    ...
                                                                                    <asp:TextBox ID="txtTitle" runat="server" Width="15px" Visible="False" Text='<%# Bind("TitleID") %>'></asp:TextBox>
                                                                                </td>
                                                                                <td>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td align="right">
                                                                                    <asp:Label ID="lblCity" runat="server" CssClass="MainfontStyle" Text="Speciality :"></asp:Label>
                                                                                </td>
                                                                                <td align="left">
                                                                                    ...
                                                                                    <asp:TextBox ID="txtSpeciality" runat="server" Width="15px" Visible="False" Text='<%# Bind("SpecialityID") %>'></asp:TextBox>
                                                                                </td>
                                                                                <td>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                ...
                                                                                <td align="left">
                                                                                    <asp:DropDownList ID="ddlBrick" runat="server" CssClass="inputs" Width="275px" DataValueField="BrickID"
                                                                                        ...
                                                                                        ondatabound="ddlBrick_DataBound">
                                                                                    </asp:DropDownList>
                                                                            ...
                                                                            <tr>
                                                                                <td align="right">
                                                                                    <asp:Label ID="lblArea" runat="server" CssClass="MainfontStyle" Text="Owns a Private Clinic :"></asp:Label>
                                                                                </td>
                                                                                <td align="left">
                                                                            ...
                                                                            <tr>
                                                                                <td align="right">
                                                                                    <asp:Label ID="lblAddress" runat="server" CssClass="MainfontStyle" Text="Mobile : "></asp:Label>
                                                                                </td>
                                                                                <td align="left">
                                                                            ...
                                                                            <tr>
                                                                                <td align="right">
                                                                                    <asp:Label ID="lblBrick" runat="server" CssClass="MainfontStyle" Text="E-mail :"></asp:Label>
                                                                                </td>
                                                                                <td align="left">
                                                                                ...
                                                                                <td align="left">
                                                                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" Display="Dynamic"
                                                                                        ControlToValidate="txtEmail" ErrorMessage="Invalid e-mail address" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*">*</asp:RegularExpressionValidator>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td align="right">
                                                                                    <asp:Label ID="lblPhone" runat="server" CssClass="MainfontStyle" Text="Postal Code :"></asp:Label>
                                                                                </td>
                                                                                <td align="left">
                                                                            ...
                                                                            <tr>
                                                                                <td valign="top" align="right">
                                                                                    <asp:Label ID="lblPhone2" runat="server" CssClass="MainfontStyle" Text="Comment :"></asp:Label>
                                                                                </td>
                                                                                <td align="left">
                                                                                    <asp:TextBox ID="txtComment" runat="server" CssClass="inputs" Height="60px" Width="270px"
                                                                                        Text='<%# Bind("Comment") %>' ReadOnly="True" TextMode="MultiLine"></asp:TextBox>
                                                                                </td>
                                                                                <td>
                                                                                </td>
                                                                            </tr>
                                                ...
                                                <td align="left">
                                                    ...
                                                    <table width="100%">
                                                        <tbody>
                                                            <tr>
                                                                <td style="height: 254px" valign="top">
                                                                            ...
                                                                            <tr>
                                                                                <td rowspan="1">
                                                                                    <table id="tblScore" runat="server" width="100%">
                                                                                        <tbody>
                                                                                            <tr>
                                                                                                <td style="height: 21px" valign="top" align="left" rowspan="1">
                                                                                                    <asp:Label ID="lblScore" runat="server" CssClass="MainfontStyle" Text="Scoring System :"></asp:Label>
                                                                                                </td>
                                                                                                <td style="height: 21px" valign="top" align="left" rowspan="1">
                                                                                                </td>
                                                                                            </tr>
                                                                                        ...
                                                                                        <tbody>
                                                                                            <tr>
                                                                                                <td valign="top" align="left" rowspan="1">
                                                                                                    ...
                                                                                                    <asp:TextBox ID="txtAISearchMA" runat="server" CssClass="inputs" Width="100%" Visible="False">Search</asp:TextBox>
                                                                                                </td>
                                                                                                <td valign="top" align="left" rowspan="1">
                                                                                                </td>
                                                                                            </tr>
                                            ...
                                            <tr>
                                                <td align="center" colspan="3" rowspan="1">
                                                    <asp:Label ID="lblErrors" runat="server" CssClass="StyleValidationSummary" ForeColor="Red"></asp:Label>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                            ...
                                            <tr>
                                                                    ...
                                                                    <table width="100%">
                                                                        <tbody>
                                                                            <tr>
                                                                                ...
                                                                                <td align="left">
                                                                                    <asp:TextBox ID="txtPhysicianName" runat="server" CssClass="inputs" ReadOnly="True"
                                                                                        Text='<%# Bind("PhysicianName") %>' Width="270px"></asp:TextBox>
                                                                                </td>
                                                                                <td align="left">
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td align="left">
                                                                                    <asp:DropDownList ID="ddlTitle" runat="server" CssClass="inputs" Width="275px" DataValueField="SID"
                                                                                        DataTextField="SubCode" DataSourceID="odsPhysicianTitles" Enabled="False">
                                                                                    </asp:DropDownList>
                                                                                    <asp:TextBox ID="txtTitle" runat="server" Text='<%# Bind("TitleID") %>' Visible="False"
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td align="left">
                                                                                    <asp:DropDownList ID="ddlSpeciality" runat="server" CssClass="inputs" Width="275px"
                                                                                        DataValueField="SID" DataTextField="SubCode" DataSourceID="odsPhysicianSpecialitities"
                                                                                        Enabled="False">
                                                                                    </asp:DropDownList>
                                                                                    <asp:TextBox ID="txtSpeciality" runat="server" Text='<%# Bind("SpecialityID") %>'
                                                                                        Visible="False" Width="15px"></asp:TextBox>
                                                                                </td>
                                                                                <td>
                                                                                </td>
                                                                            </tr>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td align="left">
                                                                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtEmail"
                                                                                        Display="Dynamic" ErrorMessage="Invalid e-mail address" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*">*</asp:RegularExpressionValidator>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td align="right">
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td align="left">
                                                                                    <asp:TextBox ID="txtComment" runat="server" CssClass="inputs" Height="60px" ReadOnly="True"
                                                                                        Text='<%# Bind("Comment") %>' TextMode="MultiLine" Width="270px"></asp:TextBox>
                                                                                </td>
                                                                                <td>
                                                                                </td>
                                                                            </tr>
                                                ...
                                                <td align="left">
                                                    ...
                                                    <table>
                                                        <tbody>
                                                            <tr>
                                                                <td style="height: 254px" valign="top" colspan="3">
                                                                    <table class="tblStyle" cellspacing="0" cellpadding="0" width="100%">
                                                                        <tbody>
                                                                            <tr>
                                            ...
                                            <tr>
                                                <td align="center" colspan="1" valign="top">
                                                    &nbsp;<asp:ValidationSummary ID="ValidationSummary1" runat="server" 
                                                        CssClass="StyleValidationSummary" />
                                                </td>
                                                <td>
                                                </td>
                                                <td>
