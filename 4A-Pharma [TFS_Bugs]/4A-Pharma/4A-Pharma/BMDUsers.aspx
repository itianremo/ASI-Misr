<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" EnableEventValidation="false"
    CodeFile="BMDUsers.aspx.cs" Inherits="BMDUsers" Title=":: 4A-Pharma BMD :: Users ::" %>
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td style="text-align: left">
                                                                                            ...
                                                                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="txtNewUserName"
                                                                                                Display="Dynamic" ErrorMessage="Invalid Username" ValidationExpression="^([^0-9~`!@#$%\^&\*\(\)\-+=\\\|\}\]\{\['&quot;:?.>,</]{1})([^~`!@#$%\^&\*\(\)\-+=\\\|\}\]\{\['&quot;:?.>,</])*">*</asp:RegularExpressionValidator>
                                                                                            </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td align="right">
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td style="text-align: left">
                                                                                            ...
                                                                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ControlToValidate="txtNewEmployeeName"
                                                                                                Display="Dynamic" ErrorMessage="Invalid Employee Name" ValidationExpression="^([^~`!@#$%\^&\*\(\)\-+=\\\|\}\]\{\['&quot;:?.>,</]{1})([^~`!@#$%\^&\*\(\)+=\|\}\]\{\[&quot;:?></])*">*</asp:RegularExpressionValidator>
                                                                                            </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td align="right">
