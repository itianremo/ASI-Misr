<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="MedicalAccounts.aspx.cs" Inherits="MedicalAccounts" Title=":: 4A-Pharma BMD :: Medical Accounts ::" %>
    ...
    <table style="width: 100%">
        <tr>
            <td align="center" colspan="3" rowspan="3">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td valign="top" rowspan="13">
                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            ...
                                                                            <td style="text-align: left">
                                                                                ...
                                                                                <asp:RegularExpressionValidator ID="RegularExpressionValidator9" runat="server" ControlToValidate="txtName"
                                                                                        Display="Dynamic" ErrorMessage="Invalid Spelling" ValidationExpression="^([^~`!@#$%\^&\*\(\)\-+=\\\|\}\]\{\['&quot;:?.>,</]{1})([^~`!@#$%\^&\*\(\)+=\|\}\]\{\[&quot;:?></])*">*</asp:RegularExpressionValidator></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td align="right">
                                                                                <asp:Label ID="lblManagerName" runat="server" CssClass="MainfontStyle" Text="Manager Name :" Visible="False"></asp:Label></td>
                                                                            <td align="left">
                                                                                <asp:TextBox ID="txtManagerName" runat="server" CssClass="inputs" ReadOnly="True"
                                                                                    Width="270px" Visible="False">Manager Name</asp:TextBox></td>
                                                                            <td style="text-align: left">
                                                                                </td>
                                                                        </tr>
                                                                        <tr>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td style="text-align: left">
                                                                                ...
                                                                                <asp:RegularExpressionValidator ID="RegularExpressionValidator10" runat="server" ControlToValidate="txtArea"
                                                                                        Display="Dynamic" ErrorMessage="Invalid Spelling" ValidationExpression="^([^~`!@#$%\^&\*\(\)\-+=\\\|\}\]\{\['&quot;:?.>,</]{1})([^~`!@#$%\^&\*\(\)+=\|\}\]\{\[&quot;:?></])*">*</asp:RegularExpressionValidator></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td align="right">
                                                                            ...
                                                                            <td style="text-align: left">
                                                                                ...
                                                                                <asp:RegularExpressionValidator ID="RegularExpressionValidator11" runat="server" ControlToValidate="txtAddress"
                                                                                    Display="Dynamic" ErrorMessage="Invalid Spelling" ValidationExpression="^([^~`!@#$%\^&\*\(\)\-+=\\\|\}\]\{\['&quot;:?.>,</]{1})([^~`!@#$%\^&\*\(\)+=\|\}\]\{\[&quot;:?></])*">*</asp:RegularExpressionValidator></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td align="right">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td align="left">
                                                                                <asp:TextBox ID="txtPhone1" runat="server" CssClass="inputs" Text='<%# Bind("Phone") %>'
                                                                                    ReadOnly="True" Width="270px"></asp:TextBox>
                                                                                <asp:RegularExpressionValidator ID="RegularExpressionValidator12" runat="server" ControlToValidate="txtPhone1"
                                                                                    Display="Dynamic" ErrorMessage="Invalid Spelling" ValidationExpression="^([^~`!@#$%\^&\*\(\)\-+=\\\|\}\]\{\['&quot;:?.>,</]{1})([^~`!@#$%\^&\*\(\)+=\|\}\]\{\[&quot;:?></])*">*</asp:RegularExpressionValidator></td>
                                                                            <td style="text-align: left">
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            ...
                                                                            <td align="left">
                                                                                <asp:TextBox ID="txtMobile" runat="server" CssClass="inputs" Text='<%# Bind("Mobile") %>'
                                                                                    ReadOnly="True" Width="270px"></asp:TextBox>
                                                                                <asp:RegularExpressionValidator ID="RegularExpressionValidator13" runat="server" ControlToValidate="txtMobile"
                                                                                    Display="Dynamic" ErrorMessage="Invalid Spelling" ValidationExpression="^([^~`!@#$%\^&\*\(\)\-+=\\\|\}\]\{\['&quot;:?.>,</]{1})([^~`!@#$%\^&\*\(\)+=\|\}\]\{\[&quot;:?></])*">*</asp:RegularExpressionValidator></td>
                                                                            <td style="text-align: left">
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            ...
                                                                            <td align="left">
                                                                                <asp:TextBox ID="txtPostalCode" runat="server" CssClass="inputs" Text='<%# Bind("PostalCode") %>'
                                                                                    ReadOnly="True" Width="270px"></asp:TextBox>
                                                                                <asp:RegularExpressionValidator ID="RegularExpressionValidator14" runat="server" ControlToValidate="txtPostalCode"
                                                                                    Display="Dynamic" ErrorMessage="Invalid Spelling" ValidationExpression="^([^~`!@#$%\^&\*\(\)\-+=\\\|\}\]\{\['&quot;:?.>,</]{1})([^~`!@#$%\^&\*\(\)+=\|\}\]\{\[&quot;:?></])*">*</asp:RegularExpressionValidator></td>
                                                                            <td style="text-align: left">
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            ...
                                                                            <td style="text-align: left">
                                                                                <asp:RegularExpressionValidator ID="RegularExpressionValidator7" runat="server" ErrorMessage="Invalid ICU NO"
                                                ...
                                                <asp:ObjectDataSource ID="odsSubordination" runat="server" TypeName="Pharma.BMD.BLL.LookupsBLL"
                                                ...
                                                <asp:ObjectDataSource ID="odsGov" runat="server" TypeName="Pharma.BMD.BLL.LookupsBLL"
                                                    SelectMethod="GetSCodeByGCode" OldValuesParameterFormatString="original_{0}">
                                                    <SelectParameters>
                                                        <asp:Parameter DefaultValue="Gov" Name="GeneralCode" />
                                                    </SelectParameters>
                                                </asp:ObjectDataSource>
                                                <asp:ObjectDataSource ID="odsBrick" runat="server" TypeName="Pharma.BMD.BLL.LookupsBLL"
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td align="left" colspan="8" rowspan="1" valign="top">
                                                                                                        <asp:CheckBox ID="cbxInternalPharmacy" runat="server" CssClass="MainfontStyle" Text="Internal Pharmacy"
                                                                                                            Enabled="False" Checked='<%# Bind("Drug_Delivery_Internal") %>'></asp:CheckBox></td>
                                                                                                    <td align="left" colspan="2" height="25" rowspan="1" valign="top">
                                                                                                    ...
                                                                                                    <td align="left" colspan="10" rowspan="1">
                                                                                                        <asp:Panel ID="pnlgvPharmacies" runat="server" Height="250px" ScrollBars="Auto" Width="100%" HorizontalAlign="Left">
                                                                                                            <asp:GridView ID="gvPharmacies" runat="server" Width="95%" AutoGenerateColumns="False"
                                                                                                                ...
                                                                                                                CellPadding="0" DataKeyNames="PharmacyID" OnRowDataBound="gvPharmacies_RowDataBound" EmptyDataText="No Pharmacies Assigned">
                                                                                                                ...
                                                                                                                <EmptyDataTemplate>
                                                                                                                    <asp:Label ID="lblNoPharmaciesAssigned" runat="server" CssClass="StyleNoData" Font-Bold="True"
                                                                                                                        Text="No Pharmacies Assigned"></asp:Label>
                                                                                                                </EmptyDataTemplate>
                                                                                                            </asp:GridView>
                                                                                                        </asp:Panel>
                                                                                                    </td>
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td style="height: 60px" align="center" colspan="15" rowspan="1">
                                                                                                        ...
                                                                                                        <asp:DropDownList ID="ddlProductsList" runat="server" CssClass="inputs" DataValueField="ProductID"
                                                                                                            ...
                                                                                                            AutoPostBack="True">
                                                                                                        </asp:DropDownList><asp:ObjectDataSource ID="odsProductsList" runat="server" TypeName="Pharma.BMD.BLL.ProductsBLL"
                                                                                        ...
                                                                                        <tr>
                                                                                            <td align="left" colspan="8" rowspan="1" valign="top">
                                                                                                <asp:CheckBox ID="cbxInternalPharmacy" runat="server" Checked='<%# Bind("Drug_Delivery_Internal") %>'
                                                                                                    CssClass="MainfontStyle" Enabled="False" Text="Internal Pharmacy" /></td>
                                                                                            <td align="left" colspan="2" height="25" rowspan="1" valign="top">
                                                                                            ...
                                                                                            <td align="left" colspan="10" rowspan="1">
                                                                                                <asp:Panel ID="pnlgvPharmacies" runat="server" Height="250px" ScrollBars="Auto" Width="100%" HorizontalAlign="Left">
                                                                                                    <asp:GridView ID="gvPharmacies" runat="server" Width="95%" AutoGenerateColumns="False"
                                                                                                        ...
                                                                                                        <EmptyDataRowStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                                                                                        <EmptyDataTemplate>
                                                                                                            <asp:Label ID="lblNoPharmaciesAssigned" runat="server" Font-Bold="True" Text="No Pharmacies Assigned" CssClass="StyleNoData"></asp:Label>
                                                                                                        </EmptyDataTemplate>
                                                                                                    </asp:GridView>
                                                                                                </asp:Panel>
                                                                                            </td>
                ...
                <asp:ObjectDataSource ID="odsMedicalAccounts" runat="server" EnablePaging="True"
                    OldValuesParameterFormatString="original_{0}" SelectCountMethod="MaxRowCount"
                    SelectMethod="SelectMedicalAccounts" TypeName="Pharma.BMD.BLL.MedicalAccountsBLL">
                    <SelectParameters>
