<%@ Control Language="c#" Inherits="TSN.ERP.WebGUI.Go.ReportWriter" CodeFile="ReportWriter.ascx.cs" %>
...
<p>
    &nbsp;</p>
<table id="Table1" style="height: 248px; width: 550px;" cellspacing="0" cellpadding="5"
    align="center" border="0" class="FunctionBlock">
    <tr>
        <td class="formslabels" valign=middle style=" width:409px; height:27px;">
            ...
            <img  alt='Go To Report Writer' 
                                               ...
                                               src="..//go/images/ReportWriter-n.jpg"
                                                onmouseover="this.src='..//go/images/ReportWriter-o.jpg'" 
                                                onmouseout="this.src='..//go/images/ReportWriter-n.jpg'"  onmousedown="this.src='..//go/images/ReportWriter-s.jpg'"  /></asp:HyperLink></td>
    </tr>
    <tr>
        <td style="width: 100%" align="center" colspan=2>
            ...
            <asp:GridView ID="dgReports" CellPadding="2" BorderColor="White" PageSize="20" Width="100%" 
